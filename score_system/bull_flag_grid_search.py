...
def run_bull_flag_grid_search(
    ...
    *,
    ...
    """
    Run a parameter grid over the bull-flag continuation strategy.

    The return shape mirrors the existing blue-chip / trend-pullback helpers so
    ...
    config_template = base_config or BullFlagStrategyConfig()
    ...
    figure = build_grid_search_figure(
        ...
        title="Bull Flag Continuation Grid Search",
    )
    return {
        "summary": summary,
        "nav_curves": nav_curves,
...
__all__ = ["run_bull_flag_grid_search"]
